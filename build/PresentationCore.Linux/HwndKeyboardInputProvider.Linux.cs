...
//
// 内容 = 上游 `upstream/wpf/src/Microsoft.DotNet.Wpf/src/PresentationCore/System/Windows/InterOp/HwndKeyboardInputProvider.cs` 逐字复制 + 3 处 T1c **只读插桩**（输入链：WM_CHAR → TextInput）。
        ...
        internal IntPtr FilterMessage(IntPtr hwnd, WindowMessage message, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            ...
            switch(message)
            {
                ...
                case WindowMessage.WM_KEYDOWN:
                {
                    ...
                    WpfLinuxInputTrace.ProviderKeyDownReset(HwndSource._eatCharMessages, handled);
