// ⚠️ 本文件由 src/WpfGfx.Linux.Native/tools/patch-presentationcore-lineheight-trace.py **生成**，不要手改。
//
    ...
    internal sealed class SimpleRun
    {
        ...
        internal double Baseline
        {
            get
            {
                ...
                double runBaseline = TextRun.Properties.Typeface.Baseline(TextRun.Properties.FontRenderingEmSize, 1, _pixelsPerDip, _textFormatterImp.TextFormattingMode);
                // ── T1c/D 只读插桩（缺省关）──
        ...
        internal double Height
        {
            get
            {
                ...
                double runHeight = TextRun.Properties.Typeface.LineSpacing(TextRun.Properties.FontRenderingEmSize, 1, _pixelsPerDip, _textFormatterImp.TextFormattingMode);
                // ── T1c/D 只读插桩（缺省关）──
