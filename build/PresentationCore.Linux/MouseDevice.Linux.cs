// ⚠️ 本文件由 src/WpfGfx.Linux.Native/tools/patch-presentationcore-mousecapture-release.py **生成**，不要手改。
//
// 内容 = 上游 `upstream/wpf/src/Microsoft.DotNet.Wpf/src/PresentationCore/System/Windows/Input/MouseDevice.cs`
//        逐字复制 + 1 处 `D-G85` 注入（在 `Capture(null)` 的释放分支补一次 `ChangeMouseCapture(null, null, CaptureMode.None, timeStamp)`）。
