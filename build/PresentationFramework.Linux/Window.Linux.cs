// ⚠️ 本文件由 src/WpfGfx.Linux.Native/tools/patch-presentationframework-window-minmax-notify.py **生成**，不要手改。
//
// 内容 = 上游 `src/Microsoft.DotNet.Wpf/src/PresentationFramework/System/Windows/Window.cs` 逐字复制 + 5 处**插入**：
...
namespace System.Windows
{
    ...
    public class Window : ContentControl, IWindowService
    {
        ...
        // ── WPF-on-Linux · 波 51（`TASK-0108` 的 `P3`）：托管侧"尺寸提示声明变了"的告示 ─────────
        ...
        private void OnMinHeightChanged(double minHeight)
        {
            ...
            // WPF-on-Linux · 波 51（`TASK-0108` 的 `P3`）：声明变了就告诉 shim 重问一次
