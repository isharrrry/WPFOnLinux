// ⚠️ 本文件由 src/WpfGfx.Linux.Native/tools/patch-presentationframework-xamlaccess.py **生成**，不要手改。
//
// 内容 = 上游 `System/Windows/SystemResources.cs` 逐字复制 +
        ...
        internal class ResourceDictionaries
        {
            ...
            private ResourceDictionary LoadDictionary(Assembly assembly, string assemblyName, string resourceName, bool isTraceEnabled, out Uri dictionarySourceUri)
            {
                ...
                if (stream != null)
                {
                    ...
                    if (assembly != null)
                    {
                        // ↓↓↓ WPF-on-Linux M7c 补丁 L：非 Windows 上不设置 AccessLevel ↓↓↓
