...
//
// 内容 = 上游 `upstream/wpf/src/Microsoft.DotNet.Wpf/src/PresentationFramework/System/Windows/Documents/TextContainer.cs` 逐字复制 + 5 处 T1c **只读插桩**（第 4 批 Q5…Q9）。
...
#endif
                            WpfLinuxPfTextDpTrace.Q5Raised(this, changes);
...
//                 VerifyAccess();
        ...
        private void BeginChange(bool undo)
        {
            ...
            // ── T1c 第 4 批 Q9a（只读插桩）：变更块**嵌套计数**（与 Q9b 配对）──
