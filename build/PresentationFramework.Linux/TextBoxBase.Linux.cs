...
//
// 内容 = 上游 `upstream/wpf/src/Microsoft.DotNet.Wpf/src/PresentationFramework/System/Windows/Controls/Primitives/TextBoxBase.cs` 逐字复制 + 4 处 T1c **只读插桩**（第 4 批 Q5…Q9）。
...
namespace System.Windows.Controls.Primitives
{
    ...
    public abstract class TextBoxBase : Control
    {
        ...
        internal virtual void OnTextContainerChanged(object sender, TextContainerChangedEventArgs e)
        {
            ...
            System.Windows.Documents.WpfLinuxPfTextDpTrace.Q6Entry(this, e, this._textContainer);
            ...
            if (!e.HasContentAddedOrRemoved && !e.HasLocalPropertyValueChange)
            {
                ...
                System.Windows.Documents.WpfLinuxPfTextDpTrace.Q6BailNoContent(this, e);
                return;
            }
            ...
            try
            {
                ...
                System.Windows.Documents.WpfLinuxPfTextDpTrace.Q6BeforeOnTextChanged(this, e, undoAction);
            ...
            // ── T1c Q6c：出口 ──
            System.Windows.Documents.WpfLinuxPfTextDpTrace.Q6Exit(this, e);
        }
