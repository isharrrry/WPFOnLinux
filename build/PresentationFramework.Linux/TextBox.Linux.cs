...
//
// 内容 = 上游 `upstream/wpf/src/Microsoft.DotNet.Wpf/src/PresentationFramework/System/Windows/Controls/TextBox.cs` 逐字复制 + 3 处 T1c **只读插桩**（第 4 批 Q5…Q9）。
...
namespace System.Windows.Controls
{
    ...
    public class TextBox : TextBoxBase, IAddChild, ITextBoxViewHost
    {
        ...
        internal override void OnTextContainerChanged(object sender, TextContainerChangedEventArgs e)
        {
            ...
            System.Windows.Documents.WpfLinuxPfTextDpTrace.Q7Entry(this, e, _isInsideTextContentChange, _changeEventNestingCount, _newTextValue);
            ...
            try
            {
                ...
                if (!_isInsideTextContentChange)
                {
                    ...
                    System.Windows.Documents.WpfLinuxPfTextDpTrace.Q7SetDeferred(this, dtr);
                }
            }
            finally
            {
            ...
            System.Windows.Documents.WpfLinuxPfTextDpTrace.Q7Exit(this, resetText, _changeEventNestingCount, _newTextValue);
