// ⚠️ 本文件由 src/WpfGfx.Linux.Native/tools/patch-presentationframework-mirror-trace.py **生成**，不要手改。
//
// 内容 = 上游 `upstream/wpf/src/Microsoft.DotNet.Wpf/src/PresentationFramework/System/Windows/Controls/TextBlock.cs` 逐字复制 + 1 处 T1c **只读插桩**（RTL 镜像：实推变换 vs 报告口径）。
