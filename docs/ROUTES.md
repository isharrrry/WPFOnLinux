...
- `TASK-0210` [Next] 🔴 **桥侧几何重发／接管**（号现场核：`TASK-0201`…`TASK-0209` 已用、**`TASK-0210` 全仓 `0` 命中**；**`D-G111` 之外不新号**）：
